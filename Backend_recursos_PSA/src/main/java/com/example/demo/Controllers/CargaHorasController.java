...
public class CargaHorasController {
    ...
    public CargaHoras updateCargaHoras(@RequestBody CargaHoras cargaHoras,@PathVariable Integer cargaId,@RequestParam(required = false) Date horasNuevas, @RequestParam(required = false) Integer cantidadHorasAct){
        return cargaHorasService.updateCargaHoras(cargaId,horasNuevas,cantidadHorasAct);
    }

    @GetMapping("/carga/{idProyecto}")
    public Integer getReporteDeHoras(Integer idProyecto){
        return cargaHorasService.getHorasDeProyecto(idProyecto);
    }

    @DeleteMapping("/carga/{idCarga}")
    public void deleteCargaHoras(@PathVariable Integer idCarga){
        cargaHorasService.deleteCargaHoras(idCarga);
    }
