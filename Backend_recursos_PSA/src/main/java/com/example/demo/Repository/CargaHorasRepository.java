...
public interface CargaHorasRepository  extends CrudRepository<CargaHoras,Integer>{
    ...
    @Query(value = "SELECT * FROM carga_horas_table c WHERE c.proyecto_id=:proyectoId",nativeQuery = true)
    public List<CargaHoras> findHorasByProyecto(@Param("tareaId")Integer proyectoId);
